...
var NYMBOT_SYSTEM_PROMPT = [
  ...
  "Info: ?help — List all bot commands, ?about — About Nymchat (version, platform links), ?nostr — Nostr protocol tips, ?changelog [version] — Live Nymchat release notes pulled from GitHub (default shows the latest release; pass a tag like ?changelog v3.70.478 for a specific version).",
...
function findRelease(releases, query) {
  ...
  // Prefix match (e.g. "3.61" matches "3.70.478")
...
function needsChangelogContext(question) {
  ...
  // Specific version reference like "3.70.478", "v3.61", "version 3.60.300"
