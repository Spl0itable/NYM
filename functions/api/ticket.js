...
import { SOCKET_TICKET_TTL_MS, issueSocketTicket, ticketMode } from './_ticket.js';
...
export async function onRequest(context) {
  ...
  return json({ ticket: issued.ticket, expiresAt: issued.expiresAt, ttl: SOCKET_TICKET_TTL_MS, mode: ticketMode(env) });
}
