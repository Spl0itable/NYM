...
Object.assign(NYM.prototype, {
    ...
    openLandingChannelSetting() {
        ...
        setTimeout(() => {
            const input = document.getElementById('pinnedLandingChannelSearch');
            if (!input) return;
            ...
            if (sec) {
                ...
                if (typeof window.persistSettingsSectionState === 'function') {
                    window.persistSettingsSectionState(sec.dataset.sectionKey, false);
                }
            }
            ...
            if (group) {
                ...
                setTimeout(() => group.classList.remove('setting-flash'), 1600);
            }
            input.focus();
        }, 60);
    },
